...
//        \app\modules\dispatcher\components\Debug::debug($pathInfo);
...
//        $pathInfo = trim($request->getPathInfo(), '/');
        ...
        $pathInfo = $extended_params;




//        \app\modules\dispatcher\components\Debug::debug($pathInfo);
//        \app\modules\dispatcher\components\Debug::debug($this->pattern);
//        die;
...
//        \app\modules\dispatcher\components\Debug::debug($matches);
...
//        \app\modules\dispatcher\components\Debug::debug($route);
//        \app\modules\dispatcher\components\Debug::debug($params);
        ...
        if(!empty($folders)) {
            $folder_params['folder_id'] = $finalFolder['id'];
            $folder_params['main_template'] = $finalFolder['main_template'];
            $folder_params['url']=$folder_path;


            if($extended_params[0] == 'page') {
                $folder_params['page'] = $extended_params[1];
                unset($extended_params[0], $extended_params[1]);
            }

            if(!empty($finalFolder['parser_node_id'])) {
                $params['parser_node_id'] = $finalFolder['parser_node_id'];
//                $folder_params['module_route_params'] = $module_route_params;
                $folder_params['module_route_params'] = $params;
            }

//\app\modules\dispatcher\components\Debug::debug($folder_params);
            return ["site/index", $folder_params];
        }
